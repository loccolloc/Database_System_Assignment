...
const Hero = () => {
  return (
    <>
      <div className="min-h-[550px] sm:min-h-[600px] bg-[url('https://e-learning.hcmut.edu.vn/theme/boost/images/slbktv.jpg?1712413413243')] flex justify-center items-center text-white">
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <div
                data-aos="fade-left"
                className="bg-blue-800 from-primary to-secondary p-3 rounded-xl absolute top-10 left-10"
              >
              ...
              <div
                data-aos="fade-right"
                data-aos-offset="0"
                className="bg-blue-800 from-primary to-secondary p-3 rounded-xl absolute bottom-10 right-10"
              >
